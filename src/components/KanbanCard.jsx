  ...
  return (
    ...
    >
      <div className="card-header">
        {ticket.parentTitle ? (
          <span className="ticket-code" style={{ border: '1px solid var(--primary)', color: 'var(--primary)', background: 'rgba(99, 102, 241, 0.1)', padding: '2px 6px', borderRadius: '4px' }}>
            {ticket.parentTitle}
          </span>
        ) : (
        ...
        <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
          {ticket.isAutoGenerated && (
            <span style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '0.65rem', padding: '2px 6px', background: 'var(--amber-3)', color: 'var(--amber-11)', borderRadius: '12px', fontWeight: 'bold' }} title="Gerado via Estimativa">
              <Bot size={12} /> Auto
            </span>
          )}
          {ticket.squadName && (
